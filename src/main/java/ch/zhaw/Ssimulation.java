...
public class Ssimulation {
	...
	private void createOktokopter() {
		/*
		oktokopter1 = new Oktokopter("Okto 1", (int)Math.round(Math.random()*100));
		oktokopter2 = new Oktokopter("Okto 2", (int)Math.round(Math.random()*100));
		oktokopter3 = new Oktokopter("Okto 3", (int)Math.round(Math.random()*100));
		oktokopter4 = new Oktokopter("Okto 4", (int)Math.round(Math.random()*100));
		oktokopter5 = new Oktokopter("Okto 5", (int)Math.round(Math.random()*100));
		oktokopter6 = new Oktokopter("Okto 6", (int)Math.round(Math.random()*100));
		oktokopter7 = new Oktokopter("Okto 7", (int)Math.round(Math.random()*100));
